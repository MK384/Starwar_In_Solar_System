...
{
    public class WoodenBox : GraphObject
    {
        
     
        public WoodenBox() : base()
        {
            setTexture("resources\\crate.jpg");
        }

        public WoodenBox(Vector3 refpoint, float scale ,bool isLumin) : base(refpoint, scale ,isLumin)
        {
            setTexture("resources\\crate.jpg");
        }
